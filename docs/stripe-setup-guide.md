...
gcloud run services update keishin-cloud \
  --update-env-vars="STRIPE_SECRET_KEY=<YOUR_KEY>,NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY=<YOUR_KEY>,STRIPE_WEBHOOK_SECRET=<YOUR_SECRET>,STRIPE_PRICE_STANDARD_YEARLY=price_xxx,STRIPE_PRICE_STANDARD_MONTHLY=price_xxx,STRIPE_PRICE_PREMIUM_YEARLY=price_xxx,STRIPE_PRICE_PREMIUM_MONTHLY=price_xxx,BYPASS_BILLING=false"
```
