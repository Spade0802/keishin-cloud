...
// X1テーブル（完成工事高→X1評点）
// ⚠️ CODE-1: brackets[30-36]（8,000,000千円〜50,000,000千円）に非単調ジャンプあり
//   - 10,000,000千円境界で+92点ジャンプ（通常は+1）
//   - 30,000,000千円境界で+77点ジャンプ
//   正式な国交省告示X1評点テーブルとの照合が必要。
//   参照: 令和5年国交省告示 別表第一（完成工事高評点X1）
